...
type
  ...
  public
    function NameServer: TNameServer;
    procedure destroy; virtual; abstract;
    procedure LabelCreate(AOwner: TForm; Left, Top: integer; Caption: String;
      var Label_: TLabel);
...
procedure TInterfaceMenuCreate.ButtonCreate(AOwner: TForm;
  Left, Top, Height, Width: integer; Caption: String; var Button_: TButton);
begin
...
procedure TInterfaceMenuCreate.ComboBoxCreate(AOwner: TForm;
  Left, Top, Width: integer; var ComboBox_: TComboBox);
begin
...
constructor TInterfaceMenuCreate.create;
begin
  if not Assigned(FInstance) then
    FInstance := TNameServer.create;
end;

procedure TInterfaceMenuCreate.EditCreate(AOwner: TForm;
  Left, Top, Width: integer; var Edit_: TEdit);
begin
